...
def segment_horizontal_surfaces(pcd, angle_threshold=45):
    ...
    Returns:
        o3d.geometry.PointCloud: Point cloud with only horizontal surface points
    """
    ...
    # Try both up and down directions to handle potential orientation issues
    #TODO: Find a fix for this orientation issue
    ...
    if len(horizontal_pcd.points) < 100:
        ...
        return segment_planes_as_horizontal(pcd)
...
def segment_planes_as_horizontal(pcd, distance_threshold=0.01, ransac_n=3, num_iterations=1000):
    ...
    Returns:
        o3d.geometry.PointCloud: Point cloud with horizontal surface points
    """
